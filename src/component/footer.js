...
export default function Footer() {
    return (
        <Box sx={{ flexGrow: 1, marginTop: '50px', backgroundImage: `url(${bgfooter})`, height: '700px', backgroundRepeat: 'no-repeat', marginTop: '150px' }}>
            <Grid container
                spacing={3}
                direction={'row'}
            ...
            >
                <Grid container item xs={12}
                    ...
                    justifyContent={'space-evenly'}
                >
                    <Grid item xs={4} sx={{ gridRow: '1', gridColumn: '2/5' }} >
                        <img src={logoft} />
                        ...
                        <Stack direction={'row'} spacing={5}>
                            <Typography variant="body1" color="initial">+521 569 8966.</Typography>
                            <Typography variant="body1" color="initial">mail@company.com</Typography>
                        </Stack>
                    </Grid>
                    <Grid item xs={4}>
                        <Typography variant="body1" color="initial">Pages</Typography>
                        <ul>
                            <li> <a>Home</a></li>
                            <li> <a>About</a></li>
                            <li> <a>Services</a></li>
                    ...
                    <Grid item xs={4}>
                        <Typography variant="body1" color="initial">Informations</Typography>
                        <ul>
                ...
                <Grid container item xs={12}>
                    <Grid item xs={6} >
                        <svg width="305" height="28" viewBox="0 0 305 28" fill="none" xmlns="http://www.w3.org/2000/svg">
